...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected Boolean doInBackground(Void... params) {
            ...
            Call<User> call = communication.login(mEmail,mPassword);
            call.enqueue(new Callback<User>() {
                ...
                public void onResponse(Call<User> call, Response<User> response) {
                    if (response.body().getId().equals("0")){
                        ...
                        success = true;
                        Intent quizList = new Intent(getApplicationContext(), QuizList.class);
                        quizList.putExtra("User_ID", response.body().getId());
                        quizList.putExtra("User_Name", response.body().getName());
